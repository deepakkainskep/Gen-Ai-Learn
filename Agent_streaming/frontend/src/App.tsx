...
//       //     setMessages(prev => {
//       //       const updated = [...prev];
//       //       updated[updated.length - 1].content = '⚠️ Error generating response';
//       //       return updated;
//       //     });
//       //   } finally {
//       //     setIsLoading(false);
...
//            {/* Header */}
//       <div className="border-b bg-white px-6 py-4 font-semibold text-lg">
//         🤖 AI Chat Assistant
//       </div>
...
//             >
//               <div
//                 className={`px-4 py-2 rounded-xl max-w-xl whitespace-pre-wrap text-sm leading-relaxed shadow-sm ${
//                   msg.role === "user"
...
//             className="px-6 py-2 bg-green-900 text-white font-bold rounded-lg disabled:opacity-50"
//           >
//             {isLoading ? "..." : "Send"}
//           </button>
//         </div>
...
//                     disabled={isLoading}
//                     className="mt-1 ml-2 text-xs text-gray-400 hover:text-black disabled:opacity-50"
//                   >
//                     🔄 Regenerate
//                   </button>
//                 )}
...
//             placeholder="Type your message..."
//             disabled={isLoading}
//             className="flex-1 px-4 py-2 border rounded-lg focus:outline-none focus:ring-1 focus:ring-black"
//           />
//           <button
//             onClick={handleSubmit}
//             disabled={isLoading || !input.trim()}
        ...
        <div className="max-w-2xl mx-auto space-y-4">
          {messages.map((msg, i) => (
            <div key={i}>
              ...
              {/* ✅ Regenerate button for ALL assistant messages (after stream only) */}
              {msg.role === "assistant" && msg.content && !isLoading && (
                <button
                  onClick={() => handleRegenerate(i)}
                  className="mt-1 ml-2 text-xs text-gray-400 hover:text-black"
                >
                  🔄 Regenerate
                </button>
              )}
